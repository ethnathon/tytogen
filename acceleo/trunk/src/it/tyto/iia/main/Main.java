...
import org.eclipse.acceleo.module.pim.uml30.profile.UML3ProfileActivator;
...
/**
 * Entry point of the 'Main30' generation module.
 * 
 * @generated
 */
public class Main extends AbstractAcceleoGenerator {
	 ...
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/it/tyto/iia/main/main";
	...
	public List<String> getProperties() {
		 ...
		 */
		URL propertiesPath = this.getClass().getResource(
				"application.properties");
		propertiesFiles.add(propertiesPath.getFile());
	...
	public void registerPackages(ResourceSet resourceSet) {
		...
		URI uriCommon = URI.createURI(UML3ProfileActivator.class.getResource("org.andromda.profile.common.profile.uml").getFile() + "/"); // for example
		uriMap.put(URI.createURI("pathmap://APP_PROFILES/org.andromda.profile.common.profile.uml"), uriCommon.appendSegment(""));
		URI uriPersistence = URI.createURI(UML3ProfileActivator.class.getResource("org.andromda.profile.persistence.profile.uml").getFile() + "/"); // for example
		uriMap.put(URI.createURI("pathmap://APP_PROFILES/org.andromda.profile.persistence.profile.uml"), uriPersistence.appendSegment(""));
		URI uriMeta = URI.createURI(UML3ProfileActivator.class.getResource("org.andromda.profile.meta.profile.uml").getFile() + "/"); // for example
		uriMap.put(URI.createURI("pathmap://APP_PROFILES/org.andromda.profile.meta.profile.uml"), uriMeta.appendSegment(""));
		URI uriMessaging = URI.createURI(UML3ProfileActivator.class.getResource("org.andromda.profile.messaging.profile.uml").getFile() + "/"); // for example
		uriMap.put(URI.createURI("pathmap://APP_PROFILES/org.andromda.profile.messaging.profile.uml"), uriMessaging.appendSegment(""));
		URI uriService = URI.createURI(UML3ProfileActivator.class.getResource("org.andromda.profile.service.profile.uml").getFile() + "/"); // for example
		uriMap.put(URI.createURI("pathmap://APP_PROFILES/org.andromda.profile.service.profile.uml"), uriService.appendSegment(""));
		URI uriPresentation = URI.createURI(UML3ProfileActivator.class.getResource("org.andromda.profile.presentation.profile.uml").getFile() + "/"); // for example
		uriMap.put(URI.createURI("pathmap://APP_PROFILES/org.andromda.profile.presentation.profile.uml"), uriPresentation.appendSegment(""));
		URI uriProcess = URI.createURI(UML3ProfileActivator.class.getResource("org.andromda.profile.process.profile.uml").getFile() + "/"); // for example
		uriMap.put(URI.createURI("pathmap://APP_PROFILES/org.andromda.profile.process.profile.uml"), uriProcess.appendSegment(""));
		URI uriWebservice = URI.createURI(UML3ProfileActivator.class.getResource("org.andromda.profile.webservice.profile.uml").getFile() + "/"); // for example
		uriMap.put(URI.createURI("pathmap://APP_PROFILES/org.andromda.profile.webservice.profile.uml"), uriWebservice.appendSegment(""));
		URI uriXml = URI.createURI(UML3ProfileActivator.class.getResource("org.andromda.profile.xml.profile.uml").getFile() + "/"); // for example
		uriMap.put(URI.createURI("pathmap://APP_PROFILES/org.andromda.profile.xml.profile.uml"), uriXml.appendSegment(""));
