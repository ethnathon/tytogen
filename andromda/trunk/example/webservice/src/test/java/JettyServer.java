...
/* Autogenerated on 06/17/2013 01:08:47+0200 by AndroMDA, can be edited
 *
...
public class JettyServer
{
    ...
    protected JettyServer() throws Exception
    {
        ...
        webappcontext.setContextPath("/iia-webservice");
        ...
        server.start();
        System.out.println("Jetty Server running on port 9090 under context iia-webservice...");
        server.join();
    }
