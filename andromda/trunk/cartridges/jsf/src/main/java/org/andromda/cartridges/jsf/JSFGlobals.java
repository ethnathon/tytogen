...
public class JSFGlobals {
	...
	/**
	 * A space-separated list of types to which displaytag table are to be
	 * exported by default.
	 */
	 ...
	 */
	public static final String PROPERTY_DEFAULT_ROLE = "defaultRole";
	/**
	...
	/**
	 * Denotes the way application resource messages ought to be generated. When
	 * messages are normalized it means that elements with the same name will
	 * reuse the same label, even if they are located in entirely different
	 * use-cases or pages.
	 * <p/>
	...
	/**
	 * Contains the default value for whether or not all forwards should perform
	 * a HTTP redirect or not.
	 */
	...
	/**
	 * The pattern for constructing the bean name under which the form is
	 * stored.
	 */
	public static final String FORM_BEAN_PATTERN = "formBeanPattern";

	/**
	 * Stores the default form scope which can be overridden with a tagged
	 * value.
	 */
	public static final String FORM_SCOPE = "formScope";

	/**
	 * Stores the pattern used for constructing the controller implementation
	 * name.
	 */
	...
	/**
	 * The namespace property used to identify the pattern used to construct the
	 * backend service's accessor.
	 */
	public static final String SERVICE_ACCESSOR_PATTERN = "serviceAccessorPattern";

	/**
	 * The namespace property used to identify the pattern used to construct the
	 * backend service's package name.
	 */
	...
	/**
	 * The pattern used for constructing the name of the filter that performs
	 * view form population.
	 */
	public static final String VIEW_POPULATOR_PATTERN = "viewPopulatorPattern";

	/**
	 * The pattern used for constructing a parameter's backing list name. A
	 * backing list is used when you want to select the value of the parameter
	 * from a list (typically used for drop-down select input types).
	 */
	public static final String BACKING_LIST_PATTERN = "backingListPattern";

	/**
	 * The pattern used for constructing a parameter's backing value name. A
	 * backing value is used when you want to select and submit values from a
	 * regular table (works well when you have a list of complex items with
	 * values you need to submit).
	 */
	public static final String BACKING_VALUE_PATTERN = "backingValuePattern";

	/**
	 * The pattern used for constructing the label list name (stores the list of
	 * possible parameter value labels).
	 */
	public static final String LABEL_LIST_PATTERN = "labelListPattern";

	/**
	 * The pattern used for constructing the values list name (stores the list
	 * of possible parameter values when selecting from a list).
	 */
	 ...
	 */
	public static final String INPUT_AUTOCOMPLETE = "autocomplete";
